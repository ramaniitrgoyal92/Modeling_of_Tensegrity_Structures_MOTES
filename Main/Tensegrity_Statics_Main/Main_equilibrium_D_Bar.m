...
D_Bar.bar_failure='yielding_n_buckling'; % 'yielding' or 'yielding_n_buckling'
...
% Solve for an equilibrium condition
[Force_den,Support_Load,LABEL,MIN_MASS,Mass_bar,Mass_string,BarWidth_in,StringWidth_in,Loop] = tenseg_equilibrium_V6(D_Bar);
